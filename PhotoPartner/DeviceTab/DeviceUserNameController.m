...
@interface DeviceUserNameController () <UIGestureRecognizerDelegate, ScanDeviceControllerDelegate, UITextFieldDelegate>
@property AppDelegate *appDelegate;
@property UITextField *deviceUserNameField;
@end

@implementation DeviceUserNameController
